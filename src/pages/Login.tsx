...
// import { toast } from 'sonner'; // We don't have sonner yet, using alert or console
...
export default function CustomAuthPage() {
  ...
  const handleAction = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signup') {
        ...
        const res = await fetch('http://localhost:15432/api/auth/register', {
          method: 'POST',
        ...
        const res = await fetch('http://localhost:15432/api/auth/verify-otp', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
        ...
        const res = await fetch('http://localhost:15432/api/auth/login', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
        ...
        const res = await fetch('http://localhost:15432/api/auth/forgot-password', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
        ...
        const res = await fetch('http://localhost:15432/api/auth/reset-password', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ 
  ...
  const handleResendOTP = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch('http://localhost:15432/api/auth/resend-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email: formData.email })
      });
